...
const GamePage: React.FC = () => {
    ...
    if (!isDesktopOrLaptop) {
        return (
            <>
    <main className='flex flex-col items-center justify-start max-h-screen text-white overflow-y-auto'>
        {/* Fight Statistics */}
        <div className='toprow flex items-center justify-center p-4'>
            ...
            <div className='bg-black bg-opacity-50 p-4 rounded-lg'>
                {playerInfo && enemyInfo && (
                    <div className='flex justify-center items-center gap-8 mt-16'>
                        <img src={playerInfo.character.icon} alt={playerInfo.character.name} className='w-28 h-28' style={{ WebkitTransform: 'scaleX(-1)', transform: 'scaleX(-1)' }} />
                        <img src={enemyInfo.character.icon} alt={enemyInfo.character.name} className='w-28 h-28' />
                    </div>
                )}
        ...
        <div className="flex items-center justify-center p-4 gap-4 bg-black bg-opacity-50 backdrop-blur-md rounded-md mb-4">
